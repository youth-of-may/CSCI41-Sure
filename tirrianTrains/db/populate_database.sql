...
-- ============================================
-- 3. STATION DATA (UPDATED - Removed isLocalStation)
-- ============================================
...
-- 7. CUSTOMER DATA
-- ============================================
INSERT INTO customer (lastName, givenName, middleInitial, birthDate, gender) VALUES
('Pevensie', 'Peter', 'W', '1927-01-15', 'Male'),
('Pevensie', 'Susan', 'A', '1928-03-20', 'Female'),
('Pevensie', 'Edmund', 'H', '1930-09-10', 'Male'),
('Pevensie', 'Lucy', 'M', '1932-05-05', 'Female'),
('Scrubb', 'Eustace', 'C', '1933-07-18', 'Male'),
('Pole', 'Jill', 'A', '1933-11-22', 'Female'),
('Kirke', 'Digory', 'A', '1888-02-14', 'Male'),
('Plummer', 'Polly', 'E', '1889-06-30', 'Female'),
('Ketterley', 'Andrew', NULL, '1850-12-01', 'Male'),
('Beaversdam', 'Tom', 'R', '1995-04-10', 'Male'),
('Archenland', 'Sarah', 'L', '1998-08-25', 'Female'),
('Caspian', 'Mary', 'J', '1975-03-15', 'Female'),
('Trumpkin', 'David', 'K', '1980-11-08', 'Male'),
('Reepicheep', 'Charles', NULL, '1992-01-20', 'Male'),
('Glenstorm', 'Anna', 'M', '1987-09-12', 'Female'),
('Rilian', 'James', 'P', '2000-07-04', 'Male'),
('Drinian', 'Elizabeth', 'S', '1985-12-18', 'Female'),
('Ramandu', 'Michael', NULL, '1970-05-22', 'Male'),
('Prunaprismia', 'Jennifer', 'A', '1990-02-28', 'Female'),
('Cornelius', 'Robert', 'T', '1965-10-15', 'Male');
